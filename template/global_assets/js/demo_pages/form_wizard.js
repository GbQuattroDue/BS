...
var FormWizard = function() {
    ...
    var _componentWizard = function() {
        ...
        $('.steps-validation').steps({
            ...
            titleTemplate: '<span class="number">#index#</span> #title#',
            labels: {
                previous: $('html').attr('dir') == 'rtl' ? '<i class="icon-arrow-right8 mr-2"></i> Previous' : '<i class="icon-arrow-left8 mr-2"></i> Volver',
                next: $('html').attr('dir') == 'rtl' ? 'Next <i class="icon-arrow-left8 ml-2"></i>' : 'Seguir <i class="icon-arrow-right8 ml-2"></i>',
                finish: 'Enviar <i class="icon-paperplane ml-2"></i>'
            },
            transitionEffect: 'fade',
            autoFocus: true,
